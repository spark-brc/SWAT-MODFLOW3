...
!       immo = immo + 1
        ...
        if (iprint /= 2 .and. curyr > nyskip) then
          ...
          write (26,6201) mo_chk, wshdmono(1), wshdmono(3), wshdmono(4),
     &                 wshdmono(104), wshdmono(114),
     &                 wshdmono(5), wshdmono(107), wshdmono(109),
     &                 wshdmono(117), !rtb drain        
     &                 wshddayo(35), wshddayo(115),
     &                 wshdmono(122), wshdmono(123), wshdmono(124),
     &                 wshdmono(7), wshdmono(108),        
     &                 wshdmono(6), wshdmono(12), wshdmono(42), 
     &                 wshdmono(45), wshdmono(110), wshdmono(116),
     &                 wshdmono(46), wshdmono(44),        
     &                 wshdmono(40), wshdmono(43), wshdmono(41),        
     &                 wshdmono(111),wshddayo(118),wshddayo(119),
     &                 wshddayo(120),wshddayo(121)
          else
