...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      use parm
      use smrt_parm !rtb SWAT-MODFLOW
...
!! watershed summary water balance table
      if (iscen == 1) then
      if(mf_active.eq.1) then !rtb
      write (26,1000) prog
      write (26,1100) title
      write (26,2301) wshdaao(1), 
     &                wshdaao(39), 
     &                wshdaao(36), 
     &                wshdaao(37),
     &                wshdaao(3), 
     &                wshdaao(4),
     &                wshdaao(109),
     &                wshdaao(117), !flow from drains to channels (MODFLOW DRAIN)
     &                wshdaao(104), !flow from aquifer to channels (MODFLOW RIVER)
     &                wshdaao(113),
     &                wshdaao(122), !change in groundwater storage (MODFLOW)
     &                wshdaao(123), !constant head boundary condition flow (MODFLOW)
     &                wshdaao(114), !river seepage to aquifer (MODFLOW RIVER)
     &                wshdaao(105), 
     &                wshdaao(106), 
     &                wshdaao(107), !recharge to the water table (lagged from SWAT sepbtm)
     &                wshdaao(6),         
     &                wshdaao(5), !SWAT sepbtm (percolation from bottom of soil profile)
     &                wshdaao(7),
     &                wshdaao(124), !ET from shallow groundwater (MODFLOW EVT)
     &                wshdaao(108),
     &                wshdaao(38),            
     &                wshd_sepmm,  
     &                wshdaao(12)
...
!! watershed summary nutrient table
      ...
      write (26,1100) title
      write (26,2600)
      if(mf_active.eq.1) then !rtb MODFLOW
      write(26,2701) wshdaao(40), 
     &               wshdaao(41), 
     &               wshdaao(42), 
     &               wshdaao(45),
     &               wshdaao(111), 
     ...
     &               wshd_pinlet,
     &               wshdaao(43), 
     &               wshdaao(46), !NO3 leached
     &               wshd_plch, !P leached
     &               wshdaao(44), !N uptake
     &               wshd_pup, !P uptake
     &               wshdaao(110), !NO3 load from GW (from RT3D)
     &               wshdaao(116), !NO3 SW-GW load (from RT3D)
     &               wshdaao(120), !NO3 load from Drain cells (from RT3D)
     &               wshdaao(118), !P load from GW (from RT3D)
     &               wshdaao(119), !P SW-GW load (from RT3D)
     &               wshdaao(121) !P load from Drain cells (from RT3D)
      else
...
!! 1600 format (1x,'HRU ',i6,1x,6(a4,'  Yld =',f8.1,1x,'BIOM = ',f8.1,2x))
 ...
 !    &        t20,'OUTFLOW'/t25,'WATER = ',f8.3,' MM'/                  &
 !    &        t25,'SEDIMENT = ',f8.3,' T/HA')
 2301 format (t10,'AVE ANNUAL BASIN VALUES'//                           
     &        t15,'PRECIP = ',f8.1,' MM'/                               
     &        t15,'SNOW FALL =',f8.2,' MM'/                             
     &        t15,'SNOW MELT = ',f8.2,' MM'/                            
     &        t15,'SUBLIMATION = ',f8.2,' MM'/                          
     ...
     &        t15,'LATERAL SOIL Q =',f8.2,' MM'/                        
     &        t15,'TILE Q = ',f8.2,' MM'/
     &        t15,'DRAIN Q (MODFLOW) = ',f8.2, 'MM'/
     &        t15,'GROUNDWATER (SHAL AQ) Q = ',f8.2,' MM'/              
     &        t15,'GROUNDWATER (DEEP AQ) Q = ',f8.2,' MM'/    
     &        t15,'CHANGE IN GW STORAGE (MODFLOW) = ',f8.2,' MM'/
     &        t15,'CONSTANT HEAD Q (MODFLOW) = ',f8.2,' MM'/
     &        t15,'RIVER SEEPAGE Q = ',f8.2,' MM'/
     &        t15,'REVAP (SHAL AQ => SOIL/PLANTS) =',f8.2,' MM'/        
     &        t15,'DEEP AQ RECHARGE = ',f8.2,' MM'/
     &        t15,'TOTAL AQ RECHARGE =',f8.2,' MM'/                     
     &        t15,'TOTAL WATER YLD = ',f8.2,' MM'/                      
     &        t15,'PERCOLATION OUT OF SOIL =',f8.2,' MM'/               
     &        t15,'ET = ',f8.1,' MM'/ 
     &        t15,'ET FROM GROUNDWATER (MODFLOW) = ',f8.2,' MM'/
     &        t15,'PET = ',f8.1,'MM'/                                   
     &        t15,'TRANSMISSION LOSSES = ',f8.2,' MM'/                
     &        t15,'SEPTIC INFLOW = ',f10.2,' MM'/                       
     &        t15,'TOTAL SEDIMENT LOADING =  ',f8.3,' T/HA')
...
!     &    t20,'WATER = ',f8.3,' MM'/t20,'SEDIMENT = ',f7.3,' T/HA')
 ...
 2700 format (//,t15,'NUTRIENTS',/
     &        t20,'ORGANIC N =  ',f8.3,' (KG/HA)'/
     &        t20,'ORGANIC P =  ',f8.3,' (KG/HA)'/
     &        t20,'NO3 YIELD (SQ) =  ',f8.3,' (KG/HA)'/
     &        t20,'NO3 YIELD (LAT) = ',f8.3,' (KG/HA)'/
     &        t20,'NO3 YIELD (TILE) = ', f8.3,' (KG/HA)'/ 
     &        t20,'SOLP YIELD (TILE) = ', f8.3, '(KG/HA)'/
     &        t20,'SOLP YIELD (SURF INLET RISER) = ', f8.3,' (KG/HA)'/
     &        t20,'SOL P YIELD = ',f8.3,' (KG/HA)'/
     &        t20,'NO3 LEACHED =  ',f8.3,' (KG/HA)'/
     &        t20,'P LEACHED =  ',f8.3,' (KG/HA)'/
     &        t20,'N UPTAKE =  ',f8.3,' (KG/HA)'/
     &        t20,'P UPTAKE = ',f8.3,' (KG/HA)'/
     &        t20,'NO3 YIELD (GWQ) =  ',f8.3,' (KG/HA)')
 2701 format (//,t15,'NUTRIENTS',/
     &        t20,'ORGANIC N =  ',f8.3,' (KG/HA)'/
     &        t20,'ORGANIC P =  ',f8.3,' (KG/HA)'/
     &        t20,'NO3 YIELD (SQ) =  ',f8.3,' (KG/HA)'/
     &        t20,'NO3 YIELD (LAT) = ',f8.3,' (KG/HA)'/
     ...
     &        t20,'SOLP YIELD (TILE) = ', f8.3, '(KG/HA)'/
     &        t20,'SOLP YIELD (SURF INLET RISER) = ', f8.3,' (KG/HA)'/
     &        t20,'SOL P YIELD (SQ) = ',f8.3,' (KG/HA)'/
     &        t20,'NO3 LEACHED =  ',f8.3,' (KG/HA)'/
     &        t20,'P LEACHED =  ',f8.3,' (KG/HA)'/
     &        t20,'N UPTAKE =  ',f8.3,' (KG/HA)'/
     &        t20,'P UPTAKE = ',f8.3,' (KG/HA)'/
     &        t20,'NO3 LOAD GW (RT3D) =  ',f8.3,' (KG/HA)'/
     &        t20,'NO3 SW-GW (RT3D) =  ',f8.3,' (KG/HA)'/
     &        t20,'NO3 LOAD DRAIN (RT3D) =  ',f8.3,' (KG/HA)'/
     &        t20,'P LOAD GW (RT3D) =  ',f8.3,' (KG/HA)'/
     &        t20,'P SW-GW (RT3D) =  ',f8.3,' (KG/HA)'/
     &        t20,'P LOAD DRAIN (RT3D) =  ',f8.3,' (KG/HA)'/)
