...
!     &             (sol_no3(j1,j), j1 = 1, sol_nly(j))
      ...
      if (iprint == 1.or.iprint==3) then
        ...
        write (26,6201) iida, wshddayo(1), wshddayo(3), wshddayo(4),   !rtb addition 05-31-2016 
     &                 wshddayo(104), wshddayo(114),
     &                 wshddayo(5), wshddayo(107), wshddayo(109),
     &                 wshddayo(117), !rtb drain        
     &                 wshddayo(35), wshddayo(115),
     &                 wshddayo(122), wshddayo(123), wshddayo(124),
     &                 wshddayo(7), wshddayo(108),        
     &                 wshddayo(6), wshddayo(12) / da_ha, wshddayo(42), 
     &                 wshddayo(45),wshddayo(110),wshddayo(116),
     &                 wshddayo(46), wshddayo(44),        
     &                 wshddayo(40), wshddayo(43), wshddayo(41),        
     &                 wshddayo(111),wshddayo(118),wshddayo(119),
