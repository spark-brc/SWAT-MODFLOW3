...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      if (i_mo <= mo_chk .or. (curyr == nbyr .and. i == idal)) then
        ...
        wshdyro(9) = wshdyro(9) / 12.
          ...
          write (26,6301) iyr, wshdyro(1), wshdyro(3), wshdyro(4),
     &                 wshdyro(104), wshdyro(114),
     &                 wshdyro(5), wshdyro(107), wshdyro(109), 
     &                 wshdyro(117), !rtb drain      
     &                 wshddayo(35), wshddayo(115),
     &                 wshdyro(122), wshdyro(123), wshdyro(124),
     &                 wshdyro(7), wshdyro(108),        
     &                 wshdyro(6), wshdyro(12), wshdyro(42), 
     &                 wshdyro(45),  wshdyro(110), wshdyro(116),
     &                 wshdyro(46), wshdyro(44),        
     &                 wshdyro(40), wshdyro(43), wshdyro(41),        
     &                 wshdyro(111),wshdyro(118),wshdyro(119),
     &                 wshdyro(120),wshdyro(121)
          else
...
!         !! annual write--sediment routing (.sed)
 ...
 6301 format (i5,10f8.2,1pe12.5,1x,1pe10.3,2f8.2,2f10.2,36f8.2)
